...
<div class="jumbotron" style="margin-bottom:5px;padding-bottom:20px;">
  <h1>请 <font style="color:red"><%=name%></font> 选择题目</h1><h3>每人选一题，不可重复</h3>
</div>
<script language="Javascript">
function CheckForm()
{
  var select = $("input[name='p_id']");
...
<form action="select_do.jsp" mathod="post" onSubmit="return CheckForm();">
...
<div class="content">
	...
	<div class="text">
		<button  type="button submit" name="submit" class="btn btn-success">提交</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
